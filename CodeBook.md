...
The data set that this code book pertains to is located in the secondtidydata.txt file of this repository.
...
The secondtidydata.txt data file is a text file, containing space-separated values.
